...
import ru.accounterio.consulter.consulter_core.dto.AdviceBotTask;
import ru.accounterio.consulter.consulter_core.interfaces.RabbitProducer;

@Component
public class AdviceProducer extends RabbitProducer<AdviceBotTask> {
    @Autowired
    public AdviceProducer(RabbitTemplate rabbitTemplate) {
